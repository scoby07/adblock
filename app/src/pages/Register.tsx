...
import { Shield, Mail, Lock, Eye, EyeOff, User, Chrome, Github } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="p-8 rounded-3xl border border-white/10 bg-navy-200/90 backdrop-blur-xl shadow-card">
          <div className="text-center mb-8">
            ...
            <p className="text-text-secondary">Start blocking ads in minutes</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              <Checkbox
                ...
                className="mt-1 border-white/20 data-[state=checked]:bg-cyan data-[state=checked]:border-cyan"
              />
              <Label htmlFor="terms" className="text-sm text-text-secondary cursor-pointer">
                I agree to the{' '}
                <Link to="/terms" className="text-cyan hover:text-cyan-400">
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link to="/privacy" className="text-cyan hover:text-cyan-400">
                  Privacy Policy
                </Link>
              </Label>
            </div>
          ...
          <p className="text-center mt-6 text-text-secondary">
            ...
            <Link to="/login" className="text-cyan hover:text-cyan-400 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
